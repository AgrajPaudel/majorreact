...
function executeVariableFromInput(requestParams) {
    ...
    if (pythonProcess.error) {
      ...
      try {
        ...
        const resultFilePath = `D:/python tesseract/${access_token}/z output/variable_from_input.json`;
...
module.exports = executeVariableFromInput;
