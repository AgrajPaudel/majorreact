...
function executeBankandQuarterExisting(requestParams) {
    ...
    if (pythonProcess.error) {
      ...
      try {
        ...
        const resultFilePath = `D:/python tesseract/${access_token}/z output/bank_and_quarter_existing.json`;
  ...
  module.exports = executeBankandQuarterExisting;