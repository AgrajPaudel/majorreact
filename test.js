...
// //here is new:
// import "E:/Major/majorreact-final/src/component/GraphTest-master/src/styles.css";
// import D3Chart from "E:/Major/majorreact-final/src/component/GraphTest-master/src/Axis";
// import Chart from "E:/Major/majorreact-final/src/component/GraphTest-master/src/ZoomGraph";
// import LineChart from "E:/Major/majorreact-final/src/component/GraphTest-master/src/LineChart";
// import Map from "E:/Major/majorreact-final/src/component/GraphTest-master/src/Map";
// import Charto from "E:/Major/majorreact-final/src/component/GraphTest-master/src/delete";
// import LineChartoo from "E:/Major/majorreact-final/src/component/GraphTest-master/src/nextwebsiteChart";
// import LineChartoss from "E:/Major/majorreact-final/src/component/GraphTest-master/src/FinalGraph";
// import GraphData  from "../class/classes.js";
// import ScatterPlotData from "../class/classesrc.js"; //scatter class

// import CreateLineChart from "../component/GraphTest-master/src/function/graph_functions.js";
// import CreateScatterPlot from "../component/GraphTest-master/src/function/scatterplot_function.js"; //scatter plot function
...
//   const [scatterplot, setscatterplot]=useState(null); //scatter 
//   const [scatterplotData, setScatterplotData] = useState(null);
//   const [selectedQuarterForScatter, setSelectedQuarterForScatter] = useState(null);

// const [selectedVariableForScatter, setSelectedVariableForScatter] = useState(null);


//   var list_of_data=[];
//   var list_of_data_scatter=[];
...
//       setlinechartdata(prevData => list_of_data);
//       setcomplete(true);
//       // setscatterplot(prevData =>{
//       //   return x;
//       // });
...
//         const scatterinstance = new ScatterPlotData(
...
//         result.quarters
//       );
//       list_of_data_scatter.push(scatterinstance);
  
//         // Add your logic here to handle the result, update state, or perform any otnpmher actions
//         // For example, you might want to setState or dispatch an action in a Redux store
...
//         // ... Add more logic as needed
//    setScatterplotData(prevData => list_of_data_scatter);
//       setscattercomplete(true);
//       } 
//       else {
//         // Handle the case where the API call was not successful
...
//         {/* New Variable Dropdown for Scatter Plot */}
//     <label>Select Variable for Scatter Plot:</label>
//     <select
//       value={selectedVariableForScatter}
//       onChange={(e) => setSelectedVariableForScatter(e.target.value)}
//       style={{ marginBottom: "10px" }}
//     >
//       <option value="">Select Variable for Scatter Plot</option>
//       {variables.map((variable, index) => (
//         <option key={index} value={variable}>
//           {variable}
//         </option>
...
// {/* Button to run the API call for Scatter Plot */}
// <button
//   onClick={handleRunVariablefromInput}
//   style={{ display: "block", marginBottom: "10px" }}
//   disabled={!selectedVariableForScatter}
// >
//   Scatter Plot Data
// </button>
...
//          {/* Render the Line Chart based on the resultData */}
//     {scatterplot && scattercomplete && <CreateScatterPlot data={scatterplot} />}
//         {/*table here*/}
