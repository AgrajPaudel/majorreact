...
function executeQuarterandVariableExisting(requestParams) {
    ...
    if (pythonProcess.error) {
      ...
      try {
        ...
        const resultFilePath = `D:/python tesseract/${access_token}/z output/variable_and_quarter_existing.json`;
  ...
  module.exports = executeQuarterandVariableExisting;