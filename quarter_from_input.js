...
function executeQuarterFromInput(requestParams) {
    ...
    if (pythonProcess.error) {
      ...
      try {
        ...
        const resultFilePath = `D:/python tesseract/${access_token}/z output/quarter_from_input.json`;
  ...
  module.exports = executeQuarterFromInput;